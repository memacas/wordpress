    ...
    protected function init_settings() {
        ...
        $this->settings = array(
            ...
            array(
                ...
                'type'     => 'text',
                'desc'     => __( 'Add a BCC recipient for emails with reminders. It can be useful to verify that emails are being sent properly. Notications about new reviews will also be sent to this email address.', IVOLE_TEXT_DOMAIN ),
                'default'  => '',
                'id'       => 'ivole_email_bcc',
                'css'      => 'min-width:300px;',
                'desc_tip' => true
